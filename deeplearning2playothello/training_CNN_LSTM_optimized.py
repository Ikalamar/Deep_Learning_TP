...
# ============================================================================
# CNN-LSTM MODEL CONFIGURATION - OPTIMIZED HYPERPARAMETERS
# ============================================================================
conf = {}
conf["board_size"] = BOARD_SIZE
conf["path_save"] = "save_models_CNN_LSTM_optimized_v2"
conf['epoch'] = 20
# Increased early stopping patience to allow better convergence with smaller batch size
